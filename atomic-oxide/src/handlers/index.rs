...
pub async fn index(req: HttpRequest) -> impl Responder {
  ...
  let registration_url = format!("{}://{}/lti/register", scheme, host);
...
<head>
  ...
  <title>Atomic Oxide - LTI Tool</title>
  <style>
    * {{
      margin: 0;
      padding: 0;
...
<body>
  ...
  <section class="hero">
    <h1>Atomic Oxide LTI Tool</h1>
    <p>A high-performance LTI 1.3 Tool built with Rust and Actix-web. Fast, reliable, and ready for production.</p>
  ...
  <section class="features">
    ...
    <div class="feature-card">
      <h3>Modern Stack</h3>
      <p>Written in Rust using Actix-web for maximum performance and reliability. Memory-safe and lightning fast.</p>
    </div>
